...
#Migration files were created in the existing prisma directory
npx prisma migrate dev --name init

#Install Prisma Client
#Automatically invokes the prisma generate
...
#In the future, you need to run this command after every change
